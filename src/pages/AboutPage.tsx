  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        <h1 className="font-serif text-4xl font-bold text-[#2B2620] mb-4">About Pawsh</h1>
        ...
        <div className="space-y-10">
          <div>
            <h2 className="text-xl font-bold text-[#2B2620] mb-2">Why we exist</h2>
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              ...
              <div key={title} className="bg-gray-50 rounded-2xl p-5">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center mb-3" style={{ backgroundColor: '#FBF1D9' }}>
                  <Icon size={17} style={{ color: '#9C7A3C' }} />
                </div>
                <h3 className="font-semibold text-sm text-[#2B2620] mb-1">{title}</h3>
          ...
          <div>
            <h2 className="text-xl font-bold text-[#2B2620] mb-2">How we're different</h2>
            <p className="text-gray-600 leading-relaxed">
        ...
        <div className="mt-14 pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="text-sm font-semibold px-5 py-2.5 rounded-xl text-[#2B2620] transition-opacity hover:opacity-90"
