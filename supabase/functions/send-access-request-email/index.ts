      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td style="background:#fff;border-radius:16px;border:1px solid #E8E4DC;padding:36px 32px;">
          ...
          <p style="margin:0 0 20px;font-size:15px;color:#6B7280;line-height:1.6;">
            Hi ${fullName}, thanks for reaching out. We've received your access request as a <strong style="color:#2D5016;">${roleLabel}</strong>.
          </p>
          <div style="background:#F0F4E8;border-radius:12px;padding:20px 24px;margin-bottom:24px;">
            <p style="margin:0;font-size:14px;color:#2D5016;font-weight:600;">What happens next?</p>
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td style="background:#fff;border-radius:16px;border:1px solid #E8E4DC;padding:36px 32px;">
          ...
          <p style="margin:0 0 24px;font-size:15px;color:#6B7280;">Someone wants to join North Paws as a <strong style="color:#2D5016;">${roleLabel}</strong>.</p>
          ...
          <div style="margin-top:24px;text-align:center;">
            <a href="mailto:${email}" style="display:inline-block;padding:12px 28px;background:#2D5016;color:#fff;font-size:14px;font-weight:600;border-radius:10px;text-decoration:none;">Reply to Applicant</a>
          </div>
        </td></tr>
        <tr><td style="padding-top:20px;text-align:center;">
          <p style="margin:0;font-size:12px;color:#9CA3AF;">North Paws Admin Notification</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
    ...
    sends.push(
      fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          from: fromAddress,
          to: [email],
          subject: "We received your request — North Paws",
      ...
      sends.push(
        fetch("https://api.resend.com/emails", {
          ...
          body: JSON.stringify({
            from: fromAddress,
            to: [adminEmail],
            subject: `New access request from ${full_name} — North Paws`,
